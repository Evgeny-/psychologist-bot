...
2. **Тренды метрик** — как менялись настроение, тревога, стресс, продуктивность, рутина по неделям
...
2. **Metric trends** — how mood, anxiety, stress, productivity, routine changed week by week
